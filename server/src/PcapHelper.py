...
class Analyser(object):
    ...
    def getDNSQR(self, pkt):
        try:
            ...
            data = {"error when extracting DNS qr layer": e}
    ...
    def getDNSAN(self, pkt):
        try:
            ...
            for i in range(dns.ancount):
                data["".join(["an",i])] = dns.an[i]

        except Exception, e:
            data = {"error when extracting DNS an layer": e}
    ...
    def getDNSNS(self, pkt):
        ...
        try:
            ...
            for i in range(dns.nscount):
                data["".join(["ns",i])] = dns.ns[i]

        except Exception, e:
            data = {"error when extracting DNS ns layer": e}
    ...
    def getDNSAR(self, pkt):
        ...
        try:
            ...
            for i in range(dns.arcount):
                data["".join(["ar",i])] = dns.ar[i]

        except Exception, e:
            data = {"error when extracting DNS ar layer": e}
